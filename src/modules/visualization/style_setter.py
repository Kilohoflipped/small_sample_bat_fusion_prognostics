...
class StyleSetter:
    ...
    def apply_global_style(self):
        ...
        注意: 更好的做法是在 Plotter 中使用 context manager.
        这个方法仅用于兼容 Plotter 当前的设计.
        """
        # 仅设置那些通常需要全局设置的参数
        plt.rcParams['font.family'] = self._style.get('font_family', 'sans-serif')
        plt.rcParams['axes.unicode_minus'] = self._style.get('axes_unicode_minus', False)
        # 其他风格参数将在 Plotter 的 _apply_plot_style 中应用到具体的 Axes 对象
